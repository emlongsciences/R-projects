...
## \centering \large  _\textsf{\textcolor{teal}{Psycholinguist/Product Designer}}_
...
Seeking the position of Product Designer using my expertise in Psycholinguistics, experience in product design and iteration, and skills in Experimental Design & Analysis\vspace{-2em}

# \Large \textsf{\textcolor{teal}{Highlights/Skills\vspace{-1em}}}
-   Psycholinguistics and Cognitive Science -- Advanced knowledge in language production and comprehension, discourse processes, attention and memory
-   Product Design -- Developed tools used to measure various effects in language
-   Project Management -- Managed teams of researchers on several projects
-   Experimental Research -- Expertise in Experimental Design; data-collection methods include behavioral measures, eye tracking, surveys
-   Senior Data Analyst -- Planned and executed inferential statistical analyses using several approaches; consulted on various projects and taught data analysis course
-   Programming Knowledge -- _R_, _Python_, _MATLAB_, _E-Prime_, _PsyToolkit_, _Qualtrics_\vspace{-2em}
...
-   Projected graduation date: May, 2024\vspace{-2em}
...
## \textsf {\large \textbf Lead Scientist\vspace{-1em}}
### \textsf {\normalsize Learning, Memory, and Language Lab -- 2021-current\vspace{-1em}}
-   Managed several research projects examining language production and other cognitive processes
...
## \textsf {\large \textbf Senior Data Analyst\vspace{-1em}}
...
-   Communicated findings to diverse audiences through interpretation of statistical results
-   Expertise in inferential statistical methods including Mixed Effects Modeling and Bayesian statistics\vspace{-2em}
